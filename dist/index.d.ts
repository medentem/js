...
export { Protobuf };
import * as _serialport_bindings_cpp from '@serialport/bindings-cpp';
import { SerialPort as SerialPort$1 } from 'serialport';
...
interface ElectronSerialConnectionParameters {
    baudRate?: number;
    path: string;
    concurrentLogOutput: boolean;
}
...
type ConnectionType = BleConnection | HttpConnection | SerialConnection | ElectronSerialConnection;
type ConnectionTypeName = "ble" | "http" | "serial" | "electron-serial";
...
type types_ElectronSerialConnectionParameters = ElectronSerialConnectionParameters;
...
/** Allows to connect to a Meshtastic device over WebSerial */
declare class ElectronSerialConnection extends MeshDevice {
    /** Defines the connection type as serial */
    connType: ConnectionTypeName;
    protected portId: string;
    ...
    reconnect(): Promise<void>;
    /** Disconnects from the serial port */
    disconnect(): Promise<SerialPort$1 | undefined>;
    /** Pings device to check if it is avaliable */
    ping(): Promise<boolean>;
    /**
     * Sends supplied protobuf message to the radio
...
declare class Client {
     ...
     */
    createElectronSerialConnection(configId?: number): ElectronSerialConnection;
    /**
...
export { BleConnection, Client, Constants, ElectronSerialConnection, FromNumUuid, FromRadioUuid, HttpConnection, MeshDevice, type PortInfo, SerialConnection, ServiceUuid, ToRadioUuid, types as Types, index as Utils, broadcastNum, minFwVer };
